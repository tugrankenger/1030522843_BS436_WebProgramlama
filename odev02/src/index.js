const img_array=['im_1.jpeg','im_2.jpeg','im_3.jpeg'];
var selectTrue = 1;
let endIndex;
export function random_image(){
    const msg = document.getElementById("msg");
    const random_index= Math.floor(Math.random()*img_array.length);
    if(random_index==endIndex){
        random_index= (random_index+1)%img_array.length;
    }
    endIndex=random_index;
    const selected_image= img_array[random_index];
...
export function random_image_2(){
    const random_index= Math.floor(Math.random()*img_array.length);
    if(random_index==endIndex){
        random_index= (random_index+1)%img_array.length;
    }
...
export function random_image_3(){
    const random_index= Math.floor(Math.random()*img_array.length);
    if(random_index==endIndex){
        random_index= (random_index+1)%img_array.length;
    }
